  ...
  return (
    <footer className="bg-background-dark border-t border-card-gray mt-16">
      <div className="px-4 py-8">
        ...
        {/* 소셜 미디어 */}
        <div className="mb-6">
          <h4 className="text-text-white font-semibold mb-2">SNS 채널</h4>
          <div className="flex space-x-4">
            <a
              href="#"
              className="text-text-gray hover:text-text-white transition-colors cursor-not-allowed opacity-50"
            >
            ...
            <a
              href="https://www.youtube.com/@mealStack"
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@mealstack"
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-gray hover:text-text-white transition-colors"
            >
