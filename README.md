...
### 개발자 A: 인증/홈화면
- [x] 전화번호 인증 로그인 (`src/app/(auth)/login/`)
- [x] 홈화면 (`src/app/home/`)
- [ ] 사전예약 기능

### 개발자 B: 주문/결제
- [x] 상품 주문 페이지 (`src/app/products/`)
- [x] 결제 페이지 (`src/app/checkout/`)
- [ ] 토스페이먼츠 연동

### 개발자 C: 구독/마이페이지
- [x] 구독 페이지 (`src/app/subscription/`)
- [x] 마이페이지 (`src/app/mypage/`)
- [ ] 구독 관리 상세 기능
...
|--------|------|--------|------|
| 홈화면 | `/home` | 개발자 A | ✅ |
| 로그인 | `/(auth)/login` | 개발자 A | ✅ |
| 상품 주문 | `/products` | 개발자 B | ✅ |
| 구독 신청 | `/subscription` | 개발자 C | ✅ |
| 결제 | `/checkout` | 개발자 B | ✅ |
| 마이페이지 | `/mypage` | 개발자 C | ✅ |
